...
public class CreatePlayerActivity extends AppCompatActivity {
    ...
    private static final int REQUEST_LOCALISATION_PERMISION = 2001;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.createPlayerImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //CreatePlayerActivity.this.startActivityForResult(intent,REQUEST_IMAGE);
            }
        });
        ...
        binding.createPlayerCompas.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                && ActivityCompat.checkSelfPermission(CreatePlayerActivity.this,
                    ...
                    }, REQUEST_LOCALISATION_PERMISION);
                }
            }
        });
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == REQUEST_LOCALISATION_PERMISION &&
                ActivityCompat.checkSelfPermission(CreatePlayerActivity.this,
                        Manifest.permission.ACCESS_COARSE_LOCATION) == PackageManager.PERMISSION_GRANTED
                && ActivityCompat.checkSelfPermission(CreatePlayerActivity.this,
                Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
